    ...
    <div v-else>
      <div
        ...
        <div class="w-full md:w-1/2 flex flex-col md:flex-row">
          ...
          <div v-if="product.images.length > 1" class="flex flex-row mt-4 md:flex-col md:mt-0 md:ml-4 md:justify-end">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left">
          ...
          <div v-if="containsOnlySize(product.variantTypes)" class="text-gray-800">
            <div class="flex">
              <div class="mb-2 variant-label font-semibold flex items-center justify-center">
                Size
              </div>
