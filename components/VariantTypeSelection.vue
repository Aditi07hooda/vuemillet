...
import { optional } from "zod";
  ...
  const variantStyle = computed(() => props.product?.variantMatrixSelect?.[props.product.variantTypes?.[1]]);
  
  // Safe console.log statement to avoid undefined errors
  console.log(props.product?.variantMatrixSelect?.[props.product.variantTypes?.[1]]);
  </script>  