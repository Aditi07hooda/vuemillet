<template>
  <div class="mx-auto p-14">
    ...
    <p class="px-8 py-4">
      ...
      Do not continue to use The Millet Store if you do not agree to take all of
    ...
    <p class="px-8 py-4">
      We employ the use of cookies. By accessing The Millet Store, you agreed to
      use cookies in agreement with the Thirumathi Herbal &amp; Natural
    ...
    <p class="px-8 py-4">
      Unless otherwise stated, Thirumathi Herbal &amp; Natural Products and/or
      its licensors own the intellectual property rights for all material on The
      Millet Store. All intellectual property rights are reserved. You may
      access this from The Millet Store for your own personal use subjected to
    ...
    <ul class="px-8 list-disc">
      ...
      <li class="mx-4">
        Sell, rent or sub-license material from The Millet Store
      </li>
      <li class="mx-4">
        Reproduce, duplicate or copy material from The Millet Store
      </li>
    ...
    <p class="px-8 py-4">
      ...
      opinions and information in certain areas of the website. Thirumathi
      Herbal &amp; Natural Products does not filter, edit, publish or review
      Comments prior to their presence on the website. Comments do not reflect
      the views and opinions of Thirumathi Herbal &amp; Natural Products,its
      ...
      applicable laws, Thirumathi Herbal &amp; Natural Products shall not be
    ...
    <p class="px-8 py-4">
      Thirumathi Herbal &amp; Natural Products reserves the right to monitor all
    ...
    <p class="px-8 py-4">
      You hereby grant Thirumathi Herbal &amp; Natural Products a non-exclusive
    ...
    <p class="px-8 py-4">
      ...
      hyperlink compensates the absence of Thirumathi Herbal &amp; Natural
      Products; and (d) the link is in the context of general resource
      information.
    </p>
    <p class="px-8 py-4">
    ...
    <p class="px-8 py-4">
      ...
      e-mail to Thirumathi Herbal &amp; Natural Products. Please include your
    ...
    <p class="px-8 py-4">
      No use of Thirumathi Herbal &amp; Natural Products's logo or other artwork
